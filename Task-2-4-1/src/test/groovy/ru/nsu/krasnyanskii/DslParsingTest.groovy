...
@DisplayName("DSL — config file parsing")
class DslParsingTest {
    ...
    @Test
    @DisplayName("tasks {} populates task list")
    ...
    @Test
    @DisplayName("groups {} with multiple students parses correctly")
    void groupsParsedCorrectly() {
        ...
        assertEquals("Ivanov I.I.", config.findStudentByGithub("ivanov").get().fullName)
    ...
    @Test
    @DisplayName("check {} and checkPoints {} parse correctly")
    void checkAndCheckPointsParsed() {
        ...
        assertEquals("Final", cp2.name)
        assertTrue(cp2.isFinal())
        assertEquals(2, cp2.taskIds.size())
    }

    @Test
    @DisplayName("settings {} populates ScoringConfig and GradeScale")
    ...
    @Test
    @DisplayName("bonus {} creates BonusEntry records")
    ...
    @Test
    @DisplayName("activity {} creates ActivityConfig")
    ...
    @Test
    @DisplayName("importConfig merges tasks from a sub-file")
