 ...
 * <ol>
 *   <li>OrderGenerator останавливается — новые заказы не принимаются.</li>
 *   <li>Очередь закрывается — пекари допекают текущие заказы и завершают работу.</li>
 *   <li>Незапущенные заказы из очереди сериализуются.</li>
 *   <li>Склад закрывается — курьеры развозят оставшееся и завершают работу.</li>
 *   <li>Пиццы оставшиеся на складе сериализуются.</li>
 * </ol>
 * </p>
 */
